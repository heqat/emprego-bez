...
import { getPublishedJobs, getCompanyProfile } from '@/lib/storage';
...
export default function CompanyDashboardPage({
  ...
  useEffect(() => {
    const all = getPublishedJobs();
    setMyJobs(all.filter((j) => j.ownerId === ownerId));
    setProfile(getCompanyProfile(ownerId));
  }, [ownerId, refreshKey]);
